...
try {
	$conn = new PDO('mysql:host=localhost;dbname=VRanasinghe_Database_Assessment', '_VRanasinghe', 'NifqiHIY5rW1jwwx');
	...
	die("Error Connecting to Database: VRanasinghe_Database_Assessment");
}
?>