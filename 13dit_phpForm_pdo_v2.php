...
try {
	$conn = new PDO('mysql:host=localhost;dbname=VRanasinghe_13dit_phpForm', '_VRanasinghe', 'NifqiHIY5rW1jwwx');
	...
	die("Error Connecting to Database: VRanasinghe_13dit_phpForm");
}
?>